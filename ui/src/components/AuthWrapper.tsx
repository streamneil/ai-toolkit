    ...
    <div className="flex min-h-screen bg-gray-900 text-gray-100 absolute top-0 left-0 right-0 bottom-0 scroll-auto">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-800 flex-col justify-center items-center p-12">
        <div className="mb-4">
          ...
          <div className="flex items-center justify-center">
            <img src="/ostris_logo.png" alt="灵台AI大模型" className="w-auto h-24 inline" />
          </div>
        </div>
        <h1 className="text-4xl mb-6">灵台AI大模型</h1>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-3xl text-center mb-2 lg:hidden">灵台AI大模型</h2>
...
密码
              ...
              <input
                ...
                placeholder="请输入系统安全密码"
              />
              <div className='text-gray-500 text-xs mt-2'>
请输入系统启动安全密码。如有疑问请联系管理员。
              </div>
            </div>
